...
class Match(object):
    ...
    def first_innings_total(self):
        if len(self.innings_json()) > 0:
            return self.innings_json()[0]['runs']
    ...
    def venue_country(self):
        return self.match_json()['country_name']
    ...
    def match_winner(self):
        if self.team_1_id() == self.match_json()['winner_team_id']:
            return self.team_1_abbreviation()
        elif self.team_2_id() == self.match_json()['winner_team_id']:
            return self.team_2_abbreviation()
    ...
    def toss_winner_team(self):
        if self.team_1_id() == self.match_json()['toss_winner_team_id']:
            return self.team_1_abbreviation()
        elif self.team_2_id() == self.match_json()['toss_winner_team_id']:
            return self.team_2_abbreviation()
